...
func main() {
	...
	if len(os.Args) < 3 || len(os.Args) > 4 {
		...
		fmt.Println("       ./tcp-proxy :3000 :5000                         # forwards all tcp incoming TCP connections on port 3000 to 5000.")
		fmt.Println("       ./tcp-proxy :5000 :31774 -v                     # forwards all tcp incoming TCP connections on port 5000 to 31774.")
		fmt.Println("                                                       # Verbose logging is enabled.")
		fmt.Println("       ./tcp-proxy 127.0.0.1:3000 192.168.100.10:5000  # forwards all tcp incoming TCP connections on 127.0.0.1 on port 3000")
